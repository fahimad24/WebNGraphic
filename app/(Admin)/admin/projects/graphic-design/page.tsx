...
import GraphicProjectCreateButton from "@/app/(Admin)/Component/project/graphic-project-create-btn";
import GraphicProjectList from "@/app/(Admin)/Component/project/graphic-project-list";
  ...
  return (
    <div className="max-w-7xl w-full mx-auto px-5 py-10">
      <div className="flex flex-col gap-8">
        ...
        >
          <GraphicProjectList search={search} page={currentPage} />
        </Suspense>
      </div>
    </div>
  );
